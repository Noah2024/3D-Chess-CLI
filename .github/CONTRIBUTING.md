...
En-Pessent however functions very differently. Unlike say a double move, En-Pessent requries move validation during both the generation of moves, AND the during the validation of moves. This is becuase 'genMoves' and 'move' are seperated for clarity. 
